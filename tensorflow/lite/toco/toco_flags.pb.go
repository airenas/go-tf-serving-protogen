...
import (
	debug "github.com/airenas/go-tf-serving-protogen/tensorflow/compiler/mlir/lite/debug"
	stablehlo "github.com/airenas/go-tf-serving-protogen/tensorflow/compiler/mlir/quantization/stablehlo"
...
type TocoFlags struct {
	...
	// Deprecated do not use.
	//
	// Deprecated: Marked as deprecated in tensorflow/lite/toco/toco_flags.proto.
	...
	// WARNING: Experimental interface, subject to change.
	UnfoldBatchmatmul *bool `protobuf:"varint,35,opt,name=unfold_batchmatmul,json=unfoldBatchmatmul,def=0" json:"unfold_batchmatmul,omitempty"`
	...
	DisableFuseMulAndFc *bool `protobuf:"varint,53,opt,name=disable_fuse_mul_and_fc,json=disableFuseMulAndFc,def=0" json:"disable_fuse_mul_and_fc,omitempty"`
	// Indicates the quantization specs. Quantization spec can be set to either
	// a preset method or a custom method.
	// Note: This is an experimental feature
	QuantizationOptions *stablehlo.QuantizationOptions `protobuf:"bytes,54,opt,name=quantization_options,json=quantizationOptions" json:"quantization_options,omitempty"`
	// Flag to enable hlo to tf conversion.
	// This is useful to exercise StableHLO -> HLO -> TF -> TFLite path.
	//
	// Deprecated: Marked as deprecated in tensorflow/lite/toco/toco_flags.proto.
	EnableHloToTfConversion *bool `protobuf:"varint,55,opt,name=enable_hlo_to_tf_conversion,json=enableHloToTfConversion,def=0" json:"enable_hlo_to_tf_conversion,omitempty"`
	// Additional parameters for controlling debug facilities.
	DebugOptions *debug.DebugOptions `protobuf:"bytes,56,opt,name=debug_options,json=debugOptions" json:"debug_options,omitempty"`
	...
	UseBufferOffset *bool `protobuf:"varint,57,opt,name=use_buffer_offset,json=useBufferOffset,def=0" json:"use_buffer_offset,omitempty"`
	// Whether to legalize "tf.TensorList*" ops to custom tflite if they
	// can all be supported.
	LegalizeCustomTensorListOps *bool `protobuf:"varint,58,opt,name=legalize_custom_tensor_list_ops,json=legalizeCustomTensorListOps,def=0" json:"legalize_custom_tensor_list_ops,omitempty"`
}
...
const (
	...
	Default_TocoFlags_UnfoldBatchmatmul                   = bool(false)
	...
	Default_TocoFlags_DisableFuseMulAndFc                 = bool(false)
	Default_TocoFlags_EnableHloToTfConversion             = bool(false)
	Default_TocoFlags_UseBufferOffset                     = bool(false)
	Default_TocoFlags_LegalizeCustomTensorListOps         = bool(false)
)
...
func (x *TocoFlags) GetDisableFuseMulAndFc() bool {
	if x != nil && x.DisableFuseMulAndFc != nil {
		return *x.DisableFuseMulAndFc
	}
	return Default_TocoFlags_DisableFuseMulAndFc
}

func (x *TocoFlags) GetQuantizationOptions() *stablehlo.QuantizationOptions {
	if x != nil {
		return x.QuantizationOptions
	}
	return nil
}

// Deprecated: Marked as deprecated in tensorflow/lite/toco/toco_flags.proto.
func (x *TocoFlags) GetEnableHloToTfConversion() bool {
	if x != nil && x.EnableHloToTfConversion != nil {
		return *x.EnableHloToTfConversion
	}
	return Default_TocoFlags_EnableHloToTfConversion
}

func (x *TocoFlags) GetDebugOptions() *debug.DebugOptions {
	if x != nil {
...
func (x *TocoFlags) GetUseBufferOffset() bool {
	if x != nil && x.UseBufferOffset != nil {
		return *x.UseBufferOffset
	}
	return Default_TocoFlags_UseBufferOffset
}

func (x *TocoFlags) GetLegalizeCustomTensorListOps() bool {
	if x != nil && x.LegalizeCustomTensorListOps != nil {
		return *x.LegalizeCustomTensorListOps
	}
	return Default_TocoFlags_LegalizeCustomTensorListOps
}
...
var file_tensorflow_lite_toco_toco_flags_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x74, 0x6f, 0x63, 0x6f, 0x1a, 0x37, 0x74,
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x69, 0x6c,
	0x65, 0x72, 0x2f, 0x6d, 0x6c, 0x69, 0x72, 0x2f, 0x6c, 0x69, 0x74, 0x65, 0x2f, 0x64, 0x65, 0x62,
	0x75, 0x67, 0x2f, 0x64, 0x65, 0x62, 0x75, 0x67, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x4a, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c,
	...
	,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x6c,
	0x69, 0x74, 0x65, 0x2f, 0x74, 0x6f, 0x63, 0x6f, 0xa2, 0x02, 0x03, 0x54, 0x58, 0x58, 0xaa, 0x02,
...
var file_tensorflow_lite_toco_toco_flags_proto_goTypes = []interface{}{
	...
	(*stablehlo.QuantizationOptions)(nil), // 3: stablehlo.quantization.QuantizationOptions
	(*debug.DebugOptions)(nil),            // 4: tensorflow.converter.DebugOptions
}
var file_tensorflow_lite_toco_toco_flags_proto_depIdxs = []int32{
	...
	3, // 5: toco.TocoFlags.quantization_options:type_name -> stablehlo.quantization.QuantizationOptions
	4, // 6: toco.TocoFlags.debug_options:type_name -> tensorflow.converter.DebugOptions
