...
type FingerprintDef struct {
	...
	Version *framework.VersionDef `protobuf:"bytes,6,opt,name=version,proto3" json:"version,omitempty"`
}
...
func (x *FingerprintDef) GetVersion() *framework.VersionDef {
	if x != nil {
		return x.Version
	}
	return nil
...
var file_tensorflow_core_protobuf_fingerprint_proto_rawDesc = []byte{
	...
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0xb1, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
	0x2e, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x42, 0x10, 0x46, 0x69, 0x6e,
	0x67, 0x65, 0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
...
var file_tensorflow_core_protobuf_fingerprint_proto_goTypes = []interface{}{
	...
	(*framework.VersionDef)(nil), // 1: tensorflow.VersionDef
}
