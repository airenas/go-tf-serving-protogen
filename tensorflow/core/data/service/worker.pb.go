...
type GetSnapshotTaskProgressesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetSnapshotTaskProgressesRequest) Reset() {
	*x = GetSnapshotTaskProgressesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tensorflow_core_data_service_worker_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetSnapshotTaskProgressesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSnapshotTaskProgressesRequest) ProtoMessage() {}

func (x *GetSnapshotTaskProgressesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_tensorflow_core_data_service_worker_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSnapshotTaskProgressesRequest.ProtoReflect.Descriptor instead.
func (*GetSnapshotTaskProgressesRequest) Descriptor() ([]byte, []int) {
	return file_tensorflow_core_data_service_worker_proto_rawDescGZIP(), []int{6}
}

type GetSnapshotTaskProgressesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SnapshotTaskProgresses []*SnapshotTaskProgress `protobuf:"bytes,1,rep,name=snapshot_task_progresses,json=snapshotTaskProgresses,proto3" json:"snapshot_task_progresses,omitempty"`
}

func (x *GetSnapshotTaskProgressesResponse) Reset() {
	*x = GetSnapshotTaskProgressesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tensorflow_core_data_service_worker_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetSnapshotTaskProgressesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSnapshotTaskProgressesResponse) ProtoMessage() {}

func (x *GetSnapshotTaskProgressesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_tensorflow_core_data_service_worker_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSnapshotTaskProgressesResponse.ProtoReflect.Descriptor instead.
func (*GetSnapshotTaskProgressesResponse) Descriptor() ([]byte, []int) {
	return file_tensorflow_core_data_service_worker_proto_rawDescGZIP(), []int{7}
}

func (x *GetSnapshotTaskProgressesResponse) GetSnapshotTaskProgresses() []*SnapshotTaskProgress {
	if x != nil {
		return x.SnapshotTaskProgresses
	}
	return nil
}
...
var file_tensorflow_core_data_service_worker_proto_rawDesc = []byte{
	...
	0x22, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x54, 0x61,
	0x73, 0x6b, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73,
	0x68, 0x6f, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x18, 0x73, 0x6e, 0x61,
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x74, 0x65,
	...
	0x73, 0x73, 0x52, 0x16, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x54, 0x61, 0x73, 0x6b,
	0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x32, 0xa8, 0x03, 0x0a, 0x0d, 0x57,
	0x6f, 0x72, 0x6b, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58, 0x0a, 0x0b,
	0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x23, 0x2e, 0x74, 0x65,
	...
	,
	...
	0x6f, 0x77, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0xa2, 0x02, 0x03, 0x54, 0x44, 0x58, 0xaa, 0x02, 0x0f, 0x54, 0x65, 0x6e,
	0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x44, 0x61, 0x74, 0x61, 0xca, 0x02, 0x0f, 0x54,
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5c, 0x44, 0x61, 0x74, 0x61, 0xe2, 0x02,
	0x1b, 0x54, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5c, 0x44, 0x61, 0x74, 0x61,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x10, 0x54,
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x3a, 0x3a, 0x44, 0x61, 0x74, 0x61, 0x62,
...
var file_tensorflow_core_data_service_worker_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_tensorflow_core_data_service_worker_proto_goTypes = []interface{}{
	...
	(*GetSnapshotTaskProgressesRequest)(nil),  // 6: tensorflow.data.GetSnapshotTaskProgressesRequest
	(*GetSnapshotTaskProgressesResponse)(nil), // 7: tensorflow.data.GetSnapshotTaskProgressesResponse
	(*TaskDef)(nil),                           // 8: tensorflow.data.TaskDef
	(*framework.CompressedElement)(nil),       // 9: tensorflow.data.CompressedElement
	(*framework.UncompressedElement)(nil),     // 10: tensorflow.data.UncompressedElement
	(*TaskInfo)(nil),                          // 11: tensorflow.data.TaskInfo
	(*SnapshotTaskProgress)(nil),              // 12: tensorflow.data.SnapshotTaskProgress
}
var file_tensorflow_core_data_service_worker_proto_depIdxs = []int32{
	8,  // 0: tensorflow.data.ProcessTaskRequest.task:type_name -> tensorflow.data.TaskDef
	9,  // 1: tensorflow.data.GetElementResponse.compressed:type_name -> tensorflow.data.CompressedElement
	10, // 2: tensorflow.data.GetElementResponse.uncompressed:type_name -> tensorflow.data.UncompressedElement
	11, // 3: tensorflow.data.GetWorkerTasksResponse.tasks:type_name -> tensorflow.data.TaskInfo
	12, // 4: tensorflow.data.GetSnapshotTaskProgressesResponse.snapshot_task_progresses:type_name -> tensorflow.data.SnapshotTaskProgress
	0,  // 5: tensorflow.data.WorkerService.ProcessTask:input_type -> tensorflow.data.ProcessTaskRequest
	2,  // 6: tensorflow.data.WorkerService.GetElement:input_type -> tensorflow.data.GetElementRequest
	4,  // 7: tensorflow.data.WorkerService.GetWorkerTasks:input_type -> tensorflow.data.GetWorkerTasksRequest
	6,  // 8: tensorflow.data.WorkerService.GetSnapshotTaskProgresses:input_type -> tensorflow.data.GetSnapshotTaskProgressesRequest
	1,  // 9: tensorflow.data.WorkerService.ProcessTask:output_type -> tensorflow.data.ProcessTaskResponse
	3,  // 10: tensorflow.data.WorkerService.GetElement:output_type -> tensorflow.data.GetElementResponse
	5,  // 11: tensorflow.data.WorkerService.GetWorkerTasks:output_type -> tensorflow.data.GetWorkerTasksResponse
	7,  // 12: tensorflow.data.WorkerService.GetSnapshotTaskProgresses:output_type -> tensorflow.data.GetSnapshotTaskProgressesResponse
...
func file_tensorflow_core_data_service_worker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tensorflow_core_data_service_worker_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSnapshotTaskProgressesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tensorflow_core_data_service_worker_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSnapshotTaskProgressesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
