...
const (
	ModelService_GetModelStatus_FullMethodName            = "/tensorflow.serving.ModelService/GetModelStatus"
	ModelService_HandleReloadConfigRequest_FullMethodName = "/tensorflow.serving.ModelService/HandleReloadConfigRequest"
)
...
func (c *modelServiceClient) GetModelStatus(ctx context.Context, in *GetModelStatusRequest, opts ...grpc.CallOption) (*GetModelStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelService_GetModelStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) HandleReloadConfigRequest(ctx context.Context, in *ReloadConfigRequest, opts ...grpc.CallOption) (*ReloadConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelService_HandleReloadConfigRequest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ModelService_HandleReloadConfigRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ModelService_HandleReloadConfigRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
